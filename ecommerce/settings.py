...
SECRET_KEY = 'django-insecure-&-5arrh@*5h&*mnz)t_=rs)yoeohydx5)kr0q_sbfzx=0!vafy'
...
# SESSION_COOKIE_DOMAIN = None  # This allows the cookie to work across different ports
 
# CSRF_COOKIE_SAMESITE = 'None'
# SESSION_COOKIE_HTTPONLY = True
# SESSION_COOKIE_SECURE = False
# SESSION_COOKIE_SAMESITE = 'Lax'
# SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # Store sessions in the database (default)
...
# Make sure the static files directory is correctly configured
STATICFILES_DIRS = [
